            ...
            <div className="flex items-center justify-center w-1/2 p-12 space-y-6 bg-white">
                <div className="max-w-6xl">
                    ...
                    <form className="space-y-4">
                        ...
                        <button onClick={() => navigate("/")} className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 w-full bg-blue-600">
                            Sign In
                        </button>
                    </form>
